          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5"  data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              ...
              <div class="text">
                ...
                <h2 class="mb-2 font-weight-light text-black h4">Camilla Corsetti</h2>
                <span class="d-block mb-3 text-white-opacity-05">Total Boss lady</span>
                <p>Seriously guys, don't fuck with her.</p>
                <p>
